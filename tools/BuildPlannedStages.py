#!/usr/bin/env python3
"""STAGE_PLAN.md に従って、専用生成の2-1・2-2・2-5～2-7を除くステージCSVを生成する。"""
...
def main():
    for stage in STAGES:
        if stage["folder"] in {"stage_2_1", "stage_2_2", "stage_2_5", "stage_2_6", "stage_2_7"}:
            continue
        build_stage(stage)
    print("専用生成の2-1・2-2・2-5～2-7を除くステージCSVを生成しました。")
