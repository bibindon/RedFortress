...
private:
    ...
    void BuildTitleLicenseCommands();
    void EnterTitleLicense();
    void UpdateTitleLicense();
    void DrawTitleLicense();
    void ChangeTitleLicensePage(int direction);
    void ApplyTitleRenderSettings();
    void EnterDeleteConfirmation();
    void ExitDeleteConfirmation();
    void ExitTitleLanguageSelection();
    void ExitTitleLicense();
    ...
    double m_debugProfilePlayerPhysicsMilliseconds = 0.0;
    double m_debugProfileEnemyUpdateMilliseconds = 0.0;
    double m_debugProfileManagerUpdateMilliseconds = 0.0;
    double m_debugProfilePlatformSyncMilliseconds = 0.0;
    double m_debugProfileGameLogicMilliseconds = 0.0;
    ...
    unsigned int m_debugProfileMainPassMeshMix2Draws = 0;
    unsigned int m_debugProfileMainPassInstancingDraws = 0;
    int m_debugProfilePhysicsRayCastObjectCount = 0;
    int m_debugProfilePhysicsRayCastShapeObjectCount = 0;
    int m_debugProfilePhysicsCheckCollideCount = 0;
    double m_debugProfilePhysicsRayCastObjectMilliseconds = 0.0;
    double m_debugProfilePhysicsRayCastShapeObjectMilliseconds = 0.0;
    double m_debugProfilePhysicsCheckCollideMilliseconds = 0.0;
    int m_debugPhysicsRayCastObjectCount = 0;
    int m_debugPhysicsRayCastShapeObjectCount = 0;
    int m_debugPhysicsCheckCollideCount = 0;
    double m_debugPhysicsRayCastObjectMilliseconds = 0.0;
    double m_debugPhysicsRayCastShapeObjectMilliseconds = 0.0;
    double m_debugPhysicsCheckCollideMilliseconds = 0.0;
    ULONGLONG m_debugGameLoopStartTick = 0;
    ULONGLONG m_debugGameLoopEndTick = 0;
    double m_debugPlayerPhysicsAccumulatedMilliseconds = 0.0;
    double m_debugEnemyUpdateAccumulatedMilliseconds = 0.0;
    double m_debugManagerUpdateAccumulatedMilliseconds = 0.0;
...
D3DXVECTOR3 m_selectedStagePortalPosition = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
    ...
    int m_titleLicensePageIndex = 0;
    ULONGLONG m_titleLicenseBlurStartTick = 0;
